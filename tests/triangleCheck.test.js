...
describe('12 - Crie uma função de Condição de existência de um triângulo', () => {
  ...
  it('Retorne false caso a medida de qualquer um dos lados seja menor que o valor absoluto da diferença entre essas medidas', () => {
  ...
  it('Retorne true caso a medida de qualquer um dos lados seja menor que a soma das medidas dos outros dois e maior que o valor absoluto da diferença entre essas medidas', () => {
